...
def QtoA(inputfile, outputfile, Ltrim=0, trim=0):
	...
	for record in Bio.SeqIO.parse(inputfile, "fastq"):
		...
		print(colorama.Fore.BLUE +f'{record.seq[:20]}...{record.seq[-20:]} '+colorama.Style.RESET_ALL +f' sequnce number '+colorama.Fore.YELLOW+f'{len(seqs):,}'+colorama.Style.RESET_ALL, end="\r")
		seqs.append(record)
