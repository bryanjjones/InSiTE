...
def Trim(inputfile,outputfile,barcode5, primer5=GGGTTCCGCCGGATGGC, primer3=CCTAACTGCTGTGCCACT, trim3=16, trim5=21, minlen=10):
	cutadapt -a ^{barcode5}&{primer5}...{primer3} -j 0 --discard-untrimmed -o ./inprocess/temptrimmed.fastq ./{inputfile}
	cutadapt -u {trim3} -j 0 --discard-untrimmed -o ./inprocess/temptrimmed1.fastq ./inprocess/temptrimmed.fastq
	cutadapt -u -{trim5} -j 0 --discard-untrimmed -m {minlen} -o {outfile} ./inprocess/temptrimmed1.fastq
